            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-red-500/20 text-red-300 border border-red-500/30 uppercase tracking-wider">
                  Hospital Requester Portal
                </span>
                <span className="flex items-center gap-1 text-xs text-emerald-400 font-medium">
                  <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" /> Verified Clinical Unit
                </span>
              </div>
              <h1 className="text-3xl font-bold text-white">Hospital Dispatch Center</h1>
              <p className="text-gray-400 text-sm mt-1 max-w-xl">
                Emergency blood requisition and real-time donor matching engine for verified medical centers.
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass-card rounded-2xl p-5 border border-white/5 flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-gray-400 mt-0.5">Active Broadcasts</div>
          </div>
        </div>
        ...
        <div className="glass-card rounded-2xl p-5 border border-white/5 flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-gray-400 mt-0.5">Critical Urgency</div>
          </div>
        </div>
        ...
        <div className="glass-card rounded-2xl p-5 border border-white/5 flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-gray-400 mt-0.5">Auto-Escalation Active</div>
          </div>
        </div>
        ...
        <div className="glass-card rounded-2xl p-5 border border-white/5 flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-gray-400 mt-0.5">Geospatial Search Radius</div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            ...
            Hospital Blood Requests & Telemetry
          </h2>
          <Link
        ...
        {loading ? (
          ...
          <div className="glass-card rounded-2xl p-12 text-center border-dashed border-white/10 space-y-3">
            ...
            <p className="text-white font-medium">No active blood requests for this hospital</p>
            <p className="text-sm text-gray-400">Post a new blood request to begin immediate geospatial matching with nearby donors.</p>
            <div className="pt-2">
              <Link
                href="/dashboard/requests/new"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-xs text-gray-400">
                      <span>District: <strong className="text-gray-300">{req.district}</strong></span>
                      <span>Radius: <strong className="text-gray-300">{req.currentRadiusKm} km</strong></span>
