        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-10">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-1 text-sm">{t('terms.lastUpdated')}</p>
            </div>
          </div>

          <div className="space-y-6">
            <section className="bg-white/4 border border-white/8 rounded-2xl p-7">
              <h2 className="text-xl font-semibold text-white mb-3">{t('terms.s1Title')}</h2>
            ...
            <section className="bg-white/4 border border-white/8 rounded-2xl p-7">
              <h2 className="text-xl font-semibold text-white mb-3">{t('terms.s2Title')}</h2>
              <p className="text-gray-400 leading-relaxed">
                {t('terms.s2Desc')}
              </p>
            </section>
            ...
            <section className="bg-white/4 border border-white/8 rounded-2xl p-7">
              <h2 className="text-xl font-semibold text-white mb-3">{t('terms.s3Title')}</h2>
              <p className="text-gray-400 leading-relaxed">
                {t('terms.s3Desc')}
              </p>
            </section>
            ...
            <section className="bg-white/4 border border-white/8 rounded-2xl p-7">
              <h2 className="text-xl font-semibold text-white mb-3">{t('terms.s4Title')}</h2>
              <p className="text-gray-400 leading-relaxed">
                {t('terms.s4Desc')}
              </p>
            </section>
            ...
            <section className="bg-white/4 border border-white/8 rounded-2xl p-7">
              <h2 className="text-xl font-semibold text-white mb-3">{t('terms.s5Title')}</h2>
              <p className="text-gray-400 leading-relaxed">
                {t('terms.s5Desc')}
              </p>
            </section>
            ...
            <section className="bg-white/4 border border-white/8 rounded-2xl p-7">
              <h2 className="text-xl font-semibold text-white mb-3">{t('terms.s6Title')}</h2>
              <p className="text-gray-400 leading-relaxed">
                {t('terms.s6Desc')}
              </p>
            </section>
            ...
            <section className="bg-white/4 border border-white/8 rounded-2xl p-7">
              <h2 className="text-xl font-semibold text-white mb-3">{t('terms.s7Title')}</h2>
              <p className="text-gray-400 leading-relaxed">
                {t('terms.s7Desc')} {' '}
